...
class SendOptimizationFailedNotificationTest extends TestCase
{
    ...
    private SendOptimizationFailedNotification $service;
    private OptimizationJobFailed $event;
    ...
    protected function setUp(): void
    {
        ...
        $this->event = new OptimizationJobFailed(
            $this->office,
            $this->date,
            $this->mockJob,
        ...
        $this->service = new SendOptimizationFailedNotification(
    ...
    public function it_logs_error_when_notification_service_throws_exception(): void
    {
        ...
        $this->mockNotificationRecipientsQuery
            ->shouldReceive('get')
            ->once()
            ->with(NotificationTypeEnum::OPTIMIZATION_FAILED)
    ...
    public function it_sends_notifications(): void
    {
        ...
        $this->mockNotificationSender
            ...
            ->withArgs(function (NotificationSenderParams $params) {
                return $params->title === __('messages.notifications.failure_optimization.title')
                    && $params->message === __('messages.notifications.failure_optimization.message', [
